  ...
  return (
    <div>
      <div className="details-app">
        ...
        <div className="m-14 shadow-sm rounded-md border p-6">
          ...
          <hr className="my-6" />
          <div className="aboutCompany mb-6">
            <p className="text-xl font-bold">About {data.company}</p>
            <p className="text-blue-500 mt-2">
              Instagram page <i className="bi bi-arrow-up-right-square"></i>
            </p>
            <p className="mt-4">{data.aboutCompany}</p>
          </div>
          <div className="about-Job mb-6">
            <p className="text-xl font-bold">About Job</p>
            <p>{data.aboutJob}</p>
          </div>
          <p className="text-blue-500 mb-6">Learn Business Communication</p>
          <div className="whocan mb-6">
            <p className="text-xl font-bold">Who can apply</p>
          ...
          <div className="mb-6">
            <p className="text-xl font-bold">Number of openings</p>
